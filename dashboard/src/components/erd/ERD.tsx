...
export const ERD = (props: any) => {
    ...
    // const { updateGraph, addTable } = TableModal();
     ...
     */
    const tableMouseDownHandler = (e: any, table: any) => {
     ...
     */
    const getSVGCursor = ({ clientX, clientY }: { clientX: any, clientY: any }) => {
        // @ts-ignore
     ...
     * is over
     */
    const gripMouseDownHandler = (e: any) => {
    ...
    // const handlerTableSelected = (table: any) => {
    //     // 表位置移动后的 x/y 会表现不一致
